							...
							<div class="card card-custom card-border card-stretch">
								...
								<div class="card-body pt-0">
									<div class="card card-custom">
				                            ...
				                            @endif
										 <!--begin::Form-->
										 <form method="post" action="/admin/editartikel/{{$post->id}}">
										 @csrf
										  <div class="card-body">
										   <div class="form-group">
										    <label>Judul <span class="text-danger">*</span></label>
										    <input type="text" class="form-control"  placeholder="Judul" name="title" value="{{old('title') ? old('title') : $post->title }}"/>
										   </div>
										   <div class="form-group">
										   ...
										   <div class="form-group mb-1">
										    ...
										    <textarea class="summernote" id="kt_summernote_1" name="content">{{old('content') ? old('content') : $post->content }}</textarea>
										   </div>
										  </div>
