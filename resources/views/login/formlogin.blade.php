				...
				<div class="d-flex flex-center flex-row-fluid bgi-size-cover bgi-position-top bgi-no-repeat" style="background-image: url('assets/media/bg/bg-3.jpg');">
					<div class="login-form text-center p-7 position-relative overflow-hidden">
						...
						<div class="login-signin">
							<div class="mb-20">
								<h3>Masuk Ke Admin Dashboard</h3>
								<div class="text-muted font-weight-bold">Silahkan input email dan password anda:</div>
							</div>
							<form class="form" {{-- id="kt_login_signin_form" --}} action="{{ route('postlogin') }}" method="post">
							@if(session()->has('msg'))
			    			...
			    			@endif
				          	@csrf
								...
								<input type="submit" class="btn btn-primary font-weight-bold px-9 py-4 my-3 mx-4" value="login">
							</form>
							{{-- <div class="mt-10">
